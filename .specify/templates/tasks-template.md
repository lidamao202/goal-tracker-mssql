...
<!--
  ...
  - Validated independently (manual verification)
  - Delivered as an MVP increment

  NOTE: NO automated tests per constitution principle V (No Testing).
...
**Manual Validation**: [How to verify this story works on its own]
...
4. **STOP and VALIDATE**: Verify User Story 1 manually
